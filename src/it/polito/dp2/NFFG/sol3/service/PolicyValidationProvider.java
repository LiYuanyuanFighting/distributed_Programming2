...
public class PolicyValidationProvider implements MessageBodyReader<Policy> {
	...
	public PolicyValidationProvider() {
		logger = Logger.getLogger(PolicyValidationProvider.class.getName());

		try {				
			InputStream schemaStream = PolicyValidationProvider.class.getResourceAsStream("/xsd/nffgVerifier.xsd");
	...
	@Override
	public Policy readFrom(Class<Policy> type, Type genericType, Annotation[] annotations, MediaType mediaType,
